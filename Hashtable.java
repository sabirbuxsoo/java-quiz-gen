    ...
    */
    ...
    public void remove(String[] array,String valueToRemove) throws IOException
    {
        if(this.variations == 1)
        {
            ...
            String deletionQuestion = "\nQuestion(1 point)\nWhat is the resulting hash table after deleting the value at key "+this.arrayForKeys[0]+" from the hash table below?\n";
            printWriter.println(deletionQuestion);

            printWriter.println("\nHash table values, "+toString()+"\n");
            ...
            for(int j=0; j<array.length; j++)
            {
                ...
                if(array[j].equals(valueToRemove))
                {
                    ...
                    {
                        arrayForValues[j] = "-";
                        printWriter.println("*A. Hashtable 1, "+toString());
                        clear();
                        ...
                        arrayForValues[j-1] = "-";
                        printWriter.println("B. Hashtable 2, "+toString());
                        clear();
                        ...
                        arrayForValues[j-2] = "-";
                        printWriter.println("C. Hashtable 3, "+toString());
                        clear();
                        ...
                        arrayForValues[j-3] = "-";
                        printWriter.println("D. Hashtable 4, "+toString());
                        clear();
        ...
        else
        {
            ...
            String deletionQuestion = "\nQuestion(1 point)\nWhat is the resulting hash table after deleting the value at key "+this.arrayForKeys[randomKey]+" from a hash table with values shown below?\n";
            printWriter.println(deletionQuestion);

            printWriter.println("Hashtable values, "+toString());
     ...
     * @throws IOException
     */
    public void generateQuestion(String[] tArray) throws IOException
    {
        Random rd = new Random();
        String[] trueArray = new String[tArray.length];
        if(this.questionTypeChoice == 1) //Insertion question
        {
            if(this.variations == 1)
            {
                ...
                String insertionQuestion = "\nQuestion(1 point)\nWhat is the resulting hashtable after inserting the following elements "+Arrays.toString(tArray)+" in a hashtable of length "+this.maxSize+" using the linear probing scheme and the hash function is h(x) = x % "+this.maxSize+" ?\n";
                ...
                printWriter.println("*A.Hash Table 1, "+toString());
                clear();

                trueArray = shuffleArray(tArray);
                for(int j=0; j<trueArray.length; j++)
                {
                    put(trueArray[j]);
                }
                printWriter.println("B.Hash Table 2, "+toString());
                clear();

                trueArray = shuffleArray(trueArray);
                for(int a=0; a<trueArray.length; a++)
                {
                    put(trueArray[a]);
                }
                printWriter.println("C.Hash table 3, "+toString());
                clear();
                ...
                printWriter.println("D.Hash table 4, "+toString());
                clear();
            ...
            else
            {
                ...
                String insertionQuestion = "Question(1 point)\nWhat is the resulting hashtable after inserting the following elements "+Arrays.toString(tArray)+" in a hashtable of length "+this.maxSize+" using the linear probing scheme and the hash function is h(x) = x % "+this.maxSize+" ?\n";
        ...
        else if(this.questionTypeChoice == 6)// Numeric Answer question
        {
            ...
            String[] NumericAnswerQuestion = {"Question(1 point)\nWhat should be the load factor for chaining?\n*A. 1\nB. 0.5\nC. 1.5\nD. 2\nE. None of the options\n#randomize",
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String[] arr = ht.listOfRandomItems(0, 30);//{"0","20","9","2","6","5","12"};
